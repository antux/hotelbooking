	...
	acl.allow([
		
		{
			...
			allows:[
				...
				{resources:'/hotels', permissions:permissions.R}, // consulta los hoteles
				{resources:`/hotels/${patron}`, permissions:permissions.R}, // consulta un hotel
		...
		},
		{
			...
			allows:[
				{resources:`/hotels`, permissions:permissions.C}, // agrega un hotel
